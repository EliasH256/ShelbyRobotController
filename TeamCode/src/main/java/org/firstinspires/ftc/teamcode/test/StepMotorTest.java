...
public class StepMotorTest extends InitLinearOpMode
{
    ...
    private static final int MAX_MOTORS = 1;
    ...
    public void runOpMode()
    {
        ...
        while(opModeIsActive())
        {
            ...
            boolean tglAct0    = gpad1.just_pressed(ManagedGamepad.Button.A_PS4_X);
            boolean tglAct1    = gpad1.just_pressed(ManagedGamepad.Button.B_PS4_CIRCLE);
            boolean tglAct2    = gpad1.just_pressed(ManagedGamepad.Button.X_PS4_SQUARE);
            boolean tglAct3    = gpad1.just_pressed(ManagedGamepad.Button.Y_PS4_TRIANGLE);
